...
class MLP(object):
    ...
    def __init__(self, rng,  input, E, W1,B1, W2, drop_out_rate = 0.5, drop_out_embedding_rate = 0.2):
        ...
        dropout_embedding = _dropout_from_layer(rng, self.embeddingLayer.output, p=drop_out_embedding_rate)
        
        # Long Duong : modify here, using default 0.5 dropout prob 
        ...
        ############ NO NEED FOR DROP-OUT TRAINING ################ 
        # For dropout training => don't need this 
        ...
        self.dropout_negative_log_likelihood = (self.dropout_LogRegressionLayer.negative_log_likelihood)
        self.dropout_errors = self.dropout_LogRegressionLayer.errors
        # the parameters of the model are the parameters of the 3 layer it is
        # made out of
...
def test_mlp(learning_rate=0.01, L2_reg=0.00000001, n_epochs=200,
   ...
   """
    ...
    gparams = [T.grad(dropout_Cost, param) for param in classifier.params]
    ...
    train_model = theano.function(
        inputs=[index],
        outputs=(dropout_Cost,train_errors),
        updates=updates,
        givens={
    ...
    patience = 2000  # Long Duong : At least have to went through this much examples 
